...
const I18N = {
  ...
  zh: {
    ...
    sort_by:'排序', sort_featured:'精选优先', sort_year:'最新', sort_payload:'负载', sort_price:'价格', sort_views:'热门', sort_name:'名称', sort_models:'型号数', sort_country:'国家/地区', group_by:'分组', group_letter:'按字母', group_country:'按国家', search_robots:'按品牌或型号搜索…', all_categories:'全部分类', all_countries:'全部国家',
