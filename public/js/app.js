...
const I18N = {
  ...
  zh: {
    ...
    add_all_cmp:'全部加入对比', fav_group_all:'全部', tag_add_hint:'添加标签…', tag_edit:'编辑标签', tag_new_name:'新名称', tag_color:'颜色', tag_delete:'删除', tag_cancel:'取消', tag_save:'保存', tag_overview:'标签概览', tag_overview_sub:'按数量排序 · 点击筛选 · ✎ 改名/换色/删除', tag_empty:'还没有标签', tag_empty_sub:'在任意机器人卡片的标签栏输入文字即可归类收藏与最近浏览。',
